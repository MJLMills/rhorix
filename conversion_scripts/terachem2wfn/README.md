...
It is unlikely this code will be further updated as the author no longer has access to TeraChem or its associated hardware. For this reason it is not incorporated with the remaining Rhorix Perl code.
