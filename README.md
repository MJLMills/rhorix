...
<p>
Irrespective of the method, the script will add a panel to the Tool Shelf of the 3D View when in Object Mode. All defined functionality is available from the UI panel. No keyboard shortcuts are defined.
