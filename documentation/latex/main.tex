...
Python within a host is not an appropriate place for such functionality, and a number of mature programs 
already exist.
...
The minimal need for the user is typically to move the camera to get the desired part of the system in the final 
render.
...
meaning quirks of the topological analysis codes are not dealt with in QCT4B.
...
van der Waals radii to set the relative sizes of nuclear CPs.
...
Non-nuclear CPs are instead coloured by rank and singature.
